...
if __name__ == '__main__':
    ...
    ###########################################
    # User
    # okay so for example the value of (0,2) tells me: If i follow policy pi, i.e. moving right,
    # the expected reward I get is 1 (this makes sense since its a terminal state, the reward is 1 and
    # there is no discounting because the are not more states in the future)
    # 'Following policy' means that we follow all the actions the policy suggests in the given state
