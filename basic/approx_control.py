...
class Model:
    ...
    def predict(self, s, a):
        # we are merging the one hot encoded action with the state vector, concatenate them and then use rbf to
    ...
    for it in range(n_episodes):
        ...
        while not grid.game_over():
            ...
            if grid.game_over():
                ...
                # here we are using the linear model to predict a Q value for all actions a
