...
import mountain_car_rbf
from mountain_car_rbf import plot_cost_to_go, FeatureTransformer, Model, plot_running_avg
...
mountain_car_rbf.SGDRegressor = SGDRegressor
